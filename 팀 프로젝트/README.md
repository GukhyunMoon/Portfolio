...
1. [지역별 음식 유행에 따른 상권 분석](./팀%20프로젝트/E-commerce/README.md) **E-commerce**(ML)  
2. [외국인 대상 영문 법령 검색 AI](./팀%20프로젝트/NLP/README.md) **NLP**(ML / DL)  
3. [초 개인화 보드게임 추천 시스템](./팀%20프로젝트/Board%20Game/README.md) **Board Game**(ML / DL)
-----------------------------------------------------------
